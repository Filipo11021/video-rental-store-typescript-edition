...
import { constVoid } from './function/function.ts';
import { err, ok } from '@repo/type-safe-errors';
import {
  array,
  ArrayError,
  Base64Url,
...
test('Base Types', () => {
  ...
  expect(String.fromUnknown(42)).toEqual(err<StringError>({ type: 'String', value: 42 }));
  ...
  expect(formatStringError({ type: 'String', value: 42 })).toBe('A value 42 is not a string.');
...
test('brand', () => {
  ...
  const TrimmedString = brand('Trimmed', String, (value) => {
    ...
    return value.trim().length === value.length ? ok(value) : err<TrimmedStringError>({ type: 'TrimmedString', value });
  });
  ...
  expect(TrimmedString.from(' a')).toEqual(err({ type: 'TrimmedString', value: ' a' }));
  expect(TrimmedString.fromUnknown('a')).toEqual(ok('a'));
  expect(TrimmedString.fromUnknown(' a')).toEqual(err({ type: 'TrimmedString', value: ' a' }));
  ...
  expectTypeOf<typeof TrimmedString.parentType>().toEqualTypeOf<typeof String>();
  expect(isType(TrimmedString)).toBe(true);

  expectTypeOf<TrimmedString>().toEqualTypeOf<string & Brand<'Trimmed'>>();

  expectTypeOf<typeof TrimmedString.Type>().toEqualTypeOf<string & Brand<'Trimmed'>>();
  expectTypeOf<typeof TrimmedString.Error>().toEqualTypeOf<TrimmedStringError>();
  ...
  expect(NonEmptyTrimmedString.from(' a')).toEqual(err({ type: 'TrimmedString', value: ' a' }));
  expect(NonEmptyTrimmedString.from('')).toEqual(err({ type: 'NonEmptyTrimmedString', value: '' }));
  ...
  expect(NonEmptyTrimmedString.fromParent('a' as TrimmedString)).toEqual(ok('a'));
  expect(trimmedStringRefineCount).toBe(9);
  ...
  expectTypeOf<typeof NonEmptyTrimmedString.parentType>().toEqualTypeOf<typeof TrimmedString>();

  expect(isType(NonEmptyTrimmedString)).toBe(true);

  expectTypeOf<NonEmptyTrimmedString>().toEqualTypeOf<string & Brand<'Trimmed'> & Brand<'NonEmpty'>>();
  expectTypeOf<typeof NonEmptyTrimmedString.Type>().toEqualTypeOf<string & Brand<'Trimmed'> & Brand<'NonEmpty'>>();
  expectTypeOf<typeof NonEmptyTrimmedString.Input>().toEqualTypeOf<string>();
  expectTypeOf<typeof NonEmptyTrimmedString.Error>().toEqualTypeOf<NonEmptyTrimmedStringError>();
  expectTypeOf<typeof NonEmptyTrimmedString.Parent>().toEqualTypeOf<TrimmedString>();
  expectTypeOf<typeof NonEmptyTrimmedString.ParentError>().toEqualTypeOf<StringError | TrimmedStringError>();
...
test('TrimmedString', () => {
  expect(TrimmedString.from('a')).toEqual(ok('a'));
  expect(TrimmedString.from(' a')).toEqual(err({ type: 'Trimmed', value: ' a' }));
  expect(TrimmedString.fromUnknown('a')).toEqual(ok('a'));
  expect(TrimmedString.fromUnknown(' a')).toEqual(err({ type: 'Trimmed', value: ' a' }));
  expect(TrimmedString.to('a' as TrimmedString)).toEqual('a');
  expect(TrimmedString.fromParent('a')).toEqual(ok('a'));
  expect(TrimmedString.toParent('a' as TrimmedString)).toEqual('a');
  expect(TrimmedString.is('a')).toBe(true);
  ...
  const AString = brand('A', String, (value) =>
    value.includes('a') ? ok(value) : err<AStringError>({ type: 'AString', value }),
  );
  ...
  expect(TrimmedAString.from('b')).toEqual(err({ type: 'AString', value: 'b' }));
  expect(TrimmedAString.from(' a')).toEqual(err({ type: 'Trimmed', value: ' a' }));

  expectTypeOf<typeof TrimmedAString.Type>().toEqualTypeOf<string & Brand<'Trimmed'> & Brand<'A'>>();
  ...
  expectTypeOf<typeof TrimmedAString.Parent>().toEqualTypeOf<string & Brand<'A'>>();
  expectTypeOf<typeof TrimmedAString.ParentError>().toEqualTypeOf<AStringError | StringError>();
});
...
test('trim', () => {
  ...
  expect(TrimNonEmptyString.fromParent('a ' as NonEmptyString).value).toEqual('a');
});
...
test('minLength', () => {
  ...
  expect(Min1String.from('')).toEqual(err<MinLengthError<1>>({ type: 'MinLength', value: '', min: 1 }));

  expect(Min1String.fromUnknown('abc')).toEqual(ok('abc'));
  expect(Min1String.fromUnknown('')).toEqual(err<MinLengthError<1>>({ type: 'MinLength', value: '', min: 1 }));
  ...
  expect(Min1String.fromParent('')).toEqual(err<MinLengthError<1>>({ type: 'MinLength', value: '', min: 1 }));
  ...
  expectTypeOf<typeof Min1String.Type>().toEqualTypeOf<string & Brand<'MinLength1'>>();
  ...
  expect(Min1TrimmedString.from(' a')).toEqual(err<TrimmedError>({ type: 'Trimmed', value: ' a' }));
  expect(Min1TrimmedString.from('')).toEqual(err<MinLengthError<1>>({ type: 'MinLength', value: '', min: 1 }));

  expectTypeOf<typeof Min1TrimmedString.Type>().toEqualTypeOf<string & Brand<'Trimmed'> & Brand<'MinLength1'>>();
  expectTypeOf<typeof Min1TrimmedString.Input>().toEqualTypeOf<string>();
  expectTypeOf<typeof Min1TrimmedString.Error>().toEqualTypeOf<MinLengthError<1>>();
  expectTypeOf<typeof Min1TrimmedString.Parent>().toEqualTypeOf<string & Brand<'Trimmed'>>();
  expectTypeOf<typeof Min1TrimmedString.ParentError>().toEqualTypeOf<StringError | TrimmedError>();
});
...
test('maxLength', () => {
  ...
  expect(String5.from('hello!')).toEqual(err<MaxLengthError<5>>({ type: 'MaxLength', value: 'hello!', max: 5 }));
  ...
  expectTypeOf<typeof String5.Type>().toEqualTypeOf<string & Brand<'MaxLength5'>>();
  ...
  expect(TrimmedString5.from(' too long')).toEqual(err<TrimmedError>({ type: 'Trimmed', value: ' too long' }));
  ...
  expectTypeOf<typeof TrimmedString5.Type>().toEqualTypeOf<string & Brand<'Trimmed'> & Brand<'MaxLength5'>>();
  expectTypeOf<typeof TrimmedString5.Input>().toEqualTypeOf<string>();
  expectTypeOf<typeof TrimmedString5.Error>().toEqualTypeOf<MaxLengthError<5>>();
  expectTypeOf<typeof TrimmedString5.Parent>().toEqualTypeOf<string & Brand<'Trimmed'>>();
  expectTypeOf<typeof TrimmedString5.ParentError>().toEqualTypeOf<StringError | TrimmedError>();
});
...
test('length', () => {
  ...
  expect(Length1String.from('abc')).toEqual(err<LengthError<1>>({ type: 'Length', value: 'abc', exact: 1 }));
  ...
  expectTypeOf<typeof Length1String.Type>().toEqualTypeOf<string & Brand<'Length1'>>();
  ...
  expect(Length1TrimmedString.from(' too long ')).toEqual(err<TrimmedError>({ type: 'Trimmed', value: ' too long ' }));
  expect(Length1TrimmedString.from('abc')).toEqual(err<LengthError<1>>({ type: 'Length', value: 'abc', exact: 1 }));

  expectTypeOf<typeof Length1TrimmedString.Type>().toEqualTypeOf<string & Brand<'Trimmed'> & Brand<'Length1'>>();
  expectTypeOf<typeof Length1TrimmedString.Input>().toEqualTypeOf<string>();
  expectTypeOf<typeof Length1TrimmedString.Error>().toEqualTypeOf<LengthError<1>>();
  expectTypeOf<typeof Length1TrimmedString.Parent>().toEqualTypeOf<string & Brand<'Trimmed'>>();
  expectTypeOf<typeof Length1TrimmedString.ParentError>().toEqualTypeOf<StringError | TrimmedError>();
});
...
test('regex', () => {
  ...
  expect(Alphanumeric.to('abc123' as typeof Alphanumeric.Type)).toEqual('abc123');
  expect(Alphanumeric.toParent('abc123' as typeof Alphanumeric.Type)).toEqual('abc123');
  ...
  expectTypeOf<typeof Alphanumeric.Type>().toEqualTypeOf<string & Brand<'Alphanumeric'>>();
  expectTypeOf<typeof Alphanumeric.Input>().toEqualTypeOf<string>();
  expectTypeOf<typeof Alphanumeric.Error>().toEqualTypeOf<RegexError<'Alphanumeric'>>();
  ...
  const TrimmedAlphanumeric = regex('Alphanumeric', /^[a-z0-9]+$/i)(TrimmedString);
  ...
  expectTypeOf<typeof TrimmedAlphanumeric.Type>().toEqualTypeOf<string & Brand<'Trimmed'> & Brand<'Alphanumeric'>>();
  expectTypeOf<typeof TrimmedAlphanumeric.Error>().toEqualTypeOf<RegexError<'Alphanumeric'>>();
  expectTypeOf<typeof TrimmedAlphanumeric.Input>().toEqualTypeOf<string>();
  expectTypeOf<typeof TrimmedAlphanumeric.Parent>().toEqualTypeOf<string & Brand<'Trimmed'>>();
  expectTypeOf<typeof TrimmedAlphanumeric.ParentError>().toEqualTypeOf<StringError | TrimmedError>();
  ...
  expect(formatRegexError(error)).toBe('Value "invalid!" does not match the pattern for Alphanumeric: /^[a-z0-9]+$/i');
...
test('Base64Url', () => {
  ...
  expect(Base64Url.toParent('abc123_-' as typeof Base64Url.Type)).toBe('abc123_-');
  ...
  expectTypeOf<typeof Base64Url.Type>().toEqualTypeOf<string & Brand<'Base64Url'>>();
  expectTypeOf<typeof Base64Url.Input>().toEqualTypeOf<string>();
  expectTypeOf<typeof Base64Url.Error>().toEqualTypeOf<RegexError<'Base64Url'>>();
...
test('SimplePassword', () => {
  ...
  expect(SimplePassword.from('abcdefghijk12345678901234567890')).toEqual(ok('abcdefghijk12345678901234567890'));
  ...
  expect(SimplePassword.from('waytooooooooooooooooolongpasswordwaytoolongpasswordwaytoolongpassword')).toEqual(
    err({
      type: 'SimplePassword',
      value: 'waytooooooooooooooooolongpasswordwaytoolongpasswordwaytoolongpassword',
      parentError: {
        type: 'MaxLength',
        value: 'waytooooooooooooooooolongpasswordwaytoolongpasswordwaytoolongpassword',
        max: 64,
  ...
  expect(SimplePassword.fromUnknown('validPass123')).toEqual(ok('validPass123'));
  ...
  expectTypeOf<typeof SimplePassword.Type>().toEqualTypeOf<
    string & Brand<'Trimmed'> & Brand<'MaxLength64'> & Brand<'MinLength8'> & Brand<'SimplePassword'>
  >();
  expectTypeOf<typeof SimplePassword.Input>().toEqualTypeOf<string>();
  expectTypeOf<typeof SimplePassword.Error>().toEqualTypeOf<
    BrandWithoutRefineError<'SimplePassword', MinLengthError<8> | MaxLengthError<64> | TrimmedError | StringError>
  >();
...
test('id', () => {
  ...
  expect(UserId.from(invalidIdShort)).toEqual(err({ type: 'Id', value: invalidIdShort, table: 'User' }));
  expect(UserId.from(invalidIdLong)).toEqual(err({ type: 'Id', value: invalidIdLong, table: 'User' }));
  expect(UserId.from(invalidIdCharacters)).toEqual(err({ type: 'Id', value: invalidIdCharacters, table: 'User' }));
  ...
  expectTypeOf<typeof UserId.Type>().toEqualTypeOf<string & Brand<'Id'> & Brand<'User'>>();
...
test('PositiveNumber', () => {
  ...
  expect(PositiveNumber.from(0)).toEqual(err<PositiveError>({ type: 'Positive', value: 0 }));
  expect(PositiveNumber.from(-1)).toEqual(err<NonNegativeError>({ type: 'NonNegative', value: -1 }));
...
test('NegativeNumber', () => {
  ...
  expect(NegativeNumber.from(0)).toEqual(err<NegativeError>({ type: 'Negative', value: 0 }));
  expect(NegativeNumber.from(1)).toEqual(err<NonPositiveError>({ type: 'NonPositive', value: 1 }));
});

test('NonPositiveNumber', () => {
  expect(NonPositiveNumber.from(0)).toEqual(ok(0));
  expect(NonPositiveNumber.from(-1)).toEqual(ok(-1));
  expect(NonPositiveNumber.from(1)).toEqual(err<NonPositiveError>({ type: 'NonPositive', value: 1 }));
});

test('NonNegativeNumber', () => {
  expect(NonNegativeNumber.from(0)).toEqual(ok(0));
  expect(NonNegativeNumber.from(1)).toEqual(ok(1));
  expect(NonNegativeNumber.from(-1)).toEqual(err<NonNegativeError>({ type: 'NonNegative', value: -1 }));
});
...
test('greaterThanOrEqualTo', () => {
  ...
  expect(GreaterThanOrEqualTo10.from(5)).toEqual(err({ type: 'GreaterThanOrEqualTo', value: 5, min: 10 }));
...
test('greaterThan', () => {
  ...
  expect(GreaterThan5.from(5)).toEqual(err({ type: 'GreaterThan', value: 5, min: 5 }));
...
test('lessThan', () => {
  ...
  expect(LessThan10.from(10)).toEqual(err({ type: 'LessThan', value: 10, max: 10 }));
...
test('lessThanOrEqualTo', () => {
  ...
  expect(LessThanOrEqualTo10.from(11)).toEqual(err({ type: 'LessThanOrEqualTo', value: 11, max: 10 }));
...
test('NonNaNNumber', () => {
  ...
  expect(NonNaNNumber.from(NaN)).toEqual(err<NonNaNError>({ type: 'NonNaN', value: NaN }));
});

test('FiniteNumber', () => {
  expect(FiniteNumber.from(42)).toEqual(ok(42));
  expect(FiniteNumber.from(Infinity)).toEqual(err<FiniteError>({ type: 'Finite', value: Infinity }));
  expectTypeOf<typeof FiniteNumber.Type>().toEqualTypeOf<number & Brand<'Finite'>>();
});
...
test('multipleOf', () => {
  ...
  expect(MultipleOf3.from(10)).toEqual(err<MultipleOfError<3>>({ type: 'MultipleOf', value: 10, divisor: 3 }));
...
test('literal', () => {
  ...
  expect(LiteralHello.from('World')).toEqual(err({ type: 'Literal', value: 'World', expected: 'Hello' }));
  expect(Literal42.from(43)).toEqual(err({ type: 'Literal', value: 43, expected: 42 }));
  expect(LiteralTrue.from(false)).toEqual(err({ type: 'Literal', value: false, expected: true }));
  expect(LiteralNull.fromUnknown(undefined)).toEqual(err({ type: 'Literal', value: undefined, expected: null }));

  expectTypeOf<typeof LiteralHello.Type>().toEqualTypeOf<'Hello'>();
  expectTypeOf<typeof LiteralHello.Input>().toEqualTypeOf<string>();
  expectTypeOf<typeof LiteralHello.Error>().toEqualTypeOf<LiteralError<'Hello'>>();
  expectTypeOf<typeof LiteralHello.Parent>().toEqualTypeOf<'Hello'>();
  expectTypeOf<typeof LiteralHello.ParentError>().toEqualTypeOf<LiteralError<'Hello'>>();
  ...
  expectTypeOf<typeof Literal42.ParentError>().toEqualTypeOf<LiteralError<42>>();
...
test('transform', () => {
  ...
  expect(SqliteBooleanFromBooleanFromBooleanFromOnOff.from('off')).toEqual(ok(0));
  expect(SqliteBooleanFromBooleanFromBooleanFromOnOff.to(1)).toEqual('on');

  expectTypeOf<typeof SqliteBooleanFromBooleanFromBooleanFromOnOff.Type>().toEqualTypeOf<0 | 1>();
  expectTypeOf<typeof SqliteBooleanFromBooleanFromBooleanFromOnOff.Input>().toEqualTypeOf<string>();
  expectTypeOf<typeof SqliteBooleanFromBooleanFromBooleanFromOnOff.Error>().toEqualTypeOf<never>();
  expectTypeOf<typeof SqliteBooleanFromBooleanFromBooleanFromOnOff.Parent>().toEqualTypeOf<boolean>();
  expectTypeOf<typeof SqliteBooleanFromBooleanFromBooleanFromOnOff.ParentError>().toEqualTypeOf<
    UnionError<LiteralError<'on'> | LiteralError<'off'>>
  >();
  ...
  ['abc', '3.14abc', 'Infinity', 'NaN'].forEach((input) => {
    expect(NumberFromString.from(input)).toEqual(err({ type: 'NumberFromString', value: input }));
  });

  expect(NumberFromString.from(' ')).toEqual(err({ type: 'Trimmed', value: ' ' }));

  expect(NumberFromString.from('')).toEqual(err({ type: 'MinLength', value: '', min: 1 }));
  ...
  expect(NumberFromString.fromParent('42' as NonEmptyTrimmedString)).toEqual(ok(42));
  ...
  expectTypeOf<typeof NumberFromString.Error>().toEqualTypeOf<NumberFromStringError>();
  expectTypeOf<typeof NumberFromString.Parent>().toEqualTypeOf<NonEmptyTrimmedString>();
  expectTypeOf<typeof NumberFromString.ParentError>().toEqualTypeOf<MinLengthError<1> | TrimmedError | StringError>();
  ...
  expect(SingleTupleFromNumberFromString.fromParent(42 as FiniteNumber).value).toEqual([42]);
  expect(SingleTupleFromNumberFromString.toParent([42 as FiniteNumber])).toBe(42);

  expectTypeOf<typeof SingleTupleFromNumberFromString.Type>().toEqualTypeOf<readonly [FiniteNumber]>();
  expectTypeOf<typeof SingleTupleFromNumberFromString.Input>().toEqualTypeOf<string>();
  expectTypeOf<typeof SingleTupleFromNumberFromString.Error>().toEqualTypeOf<never>();
  expectTypeOf<typeof SingleTupleFromNumberFromString.Parent>().toEqualTypeOf<FiniteNumber>();
  expectTypeOf<typeof SingleTupleFromNumberFromString.ParentError>().toEqualTypeOf<
...
test('array', () => {
  ...
  expectTypeOf<typeof NumberArray.Type>().toEqualTypeOf<ReadonlyArray<number>>();
  expectTypeOf<typeof NumberArray.Input>().toEqualTypeOf<ReadonlyArray<number>>();
  expectTypeOf<typeof NumberArray.Error>().toEqualTypeOf<ArrayError<NumberError>>();
  expectTypeOf<typeof NumberArray.Parent>().toEqualTypeOf<ReadonlyArray<number>>();
  expectTypeOf<typeof NumberArray.ParentError>().toEqualTypeOf<ArrayError<NumberError>>();
  ...
  expect(TrimmedStringArray.from(['hello', 'world'])).toEqual(ok(['hello', 'world']));
  ...
  expect(TrimmedStringArray.fromParent(['test', 'trimmed'] as unknown as ReadonlyArray<TrimmedString>)).toEqual(
    ok(['test', 'trimmed']),
  );

  expect(TrimmedStringArray.fromParent(['valid', ' invalid'] as unknown as ReadonlyArray<TrimmedString>)).toEqual(
    err<ArrayError<TrimmedError>>({
      type: 'Array',
      value: ['valid', ' invalid'],
      reason: {
  ...
  expectTypeOf<typeof TrimmedStringArray.Type>().toEqualTypeOf<ReadonlyArray<TrimmedString>>();
  expectTypeOf<typeof TrimmedStringArray.Input>().toEqualTypeOf<ReadonlyArray<string>>();
  expectTypeOf<typeof TrimmedStringArray.Error>().toEqualTypeOf<ArrayError<TrimmedError>>();
  expectTypeOf<typeof TrimmedStringArray.Parent>().toEqualTypeOf<ReadonlyArray<string>>();
  expectTypeOf<typeof TrimmedStringArray.ParentError>().toEqualTypeOf<ArrayError<StringError>>();

  const NumberFromStringArray = array(NumberFromString);

  expect(NumberFromStringArray.from(['42', '3.14', '-42'])).toEqual(ok([42, 3.14, -42]));
  ...
  expect(NumberFromStringArray.from(['42', '3.14', 'abc', '-42', 'NaN'])).toEqual(
    err<ArrayError<NumberFromStringError>>({
      type: 'Array',
  ...
  expect(NumberFromStringArray.fromParent(['42' as NonEmptyTrimmedString, '3.14' as NonEmptyTrimmedString])).toEqual(
    ok([42, 3.14]),
  );

  expect(NumberFromStringArray.to([42 as FiniteNumber, 3.14 as FiniteNumber, -42 as FiniteNumber])).toEqual([
    '42',
    '3.14',
    '-42',
  ]);

  expect(NumberFromStringArray.toParent([42 as FiniteNumber, 3.14 as FiniteNumber, -42 as FiniteNumber])).toEqual([
    '42',
    '3.14',
    '-42',
  ]);
  ...
  expectTypeOf<typeof NumberFromStringArray.Type>().toEqualTypeOf<ReadonlyArray<FiniteNumber>>();
  expectTypeOf<typeof NumberFromStringArray.Input>().toEqualTypeOf<ReadonlyArray<string>>();
  expectTypeOf<typeof NumberFromStringArray.Error>().toEqualTypeOf<ArrayError<NumberFromStringError>>();
...
test('record', () => {
  ...
  expectTypeOf<typeof StringToNumber.Type>().toEqualTypeOf<Readonly<Record<string, number>>>();
  expectTypeOf<typeof StringToNumber.Input>().toEqualTypeOf<Readonly<Record<string, number>>>();
  expectTypeOf<typeof StringToNumber.Error>().toEqualTypeOf<RecordError<StringError, NumberError>>();
  expectTypeOf<typeof StringToNumber.Parent>().toEqualTypeOf<Readonly<Record<string, number>>>();
  expectTypeOf<typeof StringToNumber.ParentError>().toEqualTypeOf<RecordError<StringError, NumberError>>();
  ...
  expect(NonEmptyStringToNumber.fromParent({ key: 42 })).toEqual(ok({ key: 42 }));
  expect(NonEmptyStringToNumber.toParent({ ['key' as NonEmptyString]: 42 })).toEqual({ key: 42 });
  ...
  expectTypeOf<typeof NonEmptyStringToNumber.Type>().toEqualTypeOf<Readonly<Record<NonEmptyString, number>>>();
  expectTypeOf<typeof NonEmptyStringToNumber.Input>().toEqualTypeOf<Readonly<Record<string, number>>>();
  expectTypeOf<typeof NonEmptyStringToNumber.Error>().toEqualTypeOf<RecordError<MinLengthError<1>, NumberError>>();
  expectTypeOf<typeof NonEmptyStringToNumber.Parent>().toEqualTypeOf<Readonly<Record<string, number>>>();
  expectTypeOf<typeof NonEmptyStringToNumber.ParentError>().toEqualTypeOf<RecordError<StringError, NumberError>>();

  const StringToNumberFromString = record(String, NumberFromString);

  expect(StringToNumberFromString.from({ key: '42', anotherKey: '123' })).toEqual(ok({ key: 42, anotherKey: 123 }));
  ...
  expect(StringToNumberFromString.is({ key: '42', anotherKey: '123' })).toBe(true);
  ...
  expectTypeOf<typeof StringToNumberFromString.Type>().toEqualTypeOf<Readonly<Record<string, FiniteNumber>>>();
  expectTypeOf<typeof StringToNumberFromString.Input>().toEqualTypeOf<Readonly<Record<string, string>>>();
...
test('object', () => {
  ...
  expect(User.from({ name: 'Alice', age: 30 })).toEqual(ok({ name: 'Alice', age: 30 }));
  ...
  expect(User.to({ name: 'Alice' as NonEmptyString, age: 30 as PositiveNumber })).toEqual({
    name: 'Alice',
    age: 30,
  });
  ...
  expect(StrictUser.fromUnknown({ name: 'Alice', age: 30, extraKey: 'value' })).toEqual(
    err({
      type: 'Object',
  ...
  expect(StrictUser.from({ name: 'Alice', age: 30 })).toEqual(ok({ name: 'Alice', age: 30 }));
  ...
  expect(NumberDictionary.from({ length: 3, key1: 1, key2: 2, key3: 3 })).toEqual(
    ok({ length: 3, key1: 1, key2: 2, key3: 3 }),
  );

  expect(NumberDictionary.fromUnknown({ length: 'not a number', key1: 1 })).toEqual(
    err({
  ...
  expect(NumberDictionary.fromUnknown({ length: 3, key1: 'not a number' })).toEqual(
    err({
      type: 'ObjectWithRecord',
...
test('union', () => {
  ...
  expectTypeOf<typeof StringOrNumber.Error>().toEqualTypeOf<UnionError<StringError | NumberError>>();
  ...
  expectTypeOf<typeof StringOrNumberOrBoolean.Type>().toEqualTypeOf<string | number | true>();
  ...
  expectTypeOf<typeof aOrB.Error>().toEqualTypeOf<UnionError<LiteralError<'a'> | LiteralError<'b'>>>();
  ...
  expectTypeOf<typeof aOrBFromArray.Error>().toEqualTypeOf<UnionError<LiteralError<'a'> | LiteralError<'b'>>>();
  ...
  expectTypeOf<typeof UnionTransform.Type>().toEqualTypeOf<FiniteNumber | boolean>();
  expectTypeOf<typeof UnionTransform.Error>().toEqualTypeOf<
    UnionError<
      StringError | NumberError | TrimmedError | MinLengthError<1> | NumberFromStringError | BooleanFromNumberError
    >
  >();
...
test('nullOr', () => {
  ...
  expectTypeOf<typeof NullOrString.Error>().toEqualTypeOf<UnionError<NullError | StringError>>();
...
test('undefinedOr', () => {
  ...
  expectTypeOf<typeof UndefinedOrString.Type>().toEqualTypeOf<string | undefined>();
  expectTypeOf<typeof UndefinedOrString.Error>().toEqualTypeOf<UnionError<UndefinedError | StringError>>();
  expectTypeOf<typeof UndefinedOrString.Input>().toEqualTypeOf<string | undefined>();
  expectTypeOf<typeof UndefinedOrString.Parent>().toEqualTypeOf<string | undefined>();
...
test('nullishOr', () => {
  ...
  expectTypeOf<typeof NullishString.Type>().toEqualTypeOf<string | null | undefined>();
  expectTypeOf<typeof NullishString.Error>().toEqualTypeOf<UnionError<NullError | UndefinedError | StringError>>();
  expectTypeOf<typeof NullishString.Input>().toEqualTypeOf<string | null | undefined>();
  expectTypeOf<typeof NullishString.Parent>().toEqualTypeOf<string | null | undefined>();
...
test('tuple', () => {
  ...
  expect(TupleOfStringAndNumber.fromUnknown(['test', 123])).toEqual(ok(['test', 123]));
  ...
  expectTypeOf<typeof TupleOfStringAndNumber.Type>().toEqualTypeOf<readonly [string, number]>();
  expectTypeOf<typeof TupleOfStringAndNumber.Input>().toEqualTypeOf<readonly [string, number]>();
  expectTypeOf<typeof TupleOfStringAndNumber.Error>().toEqualTypeOf<TupleError<StringError | NumberError>>();
  expectTypeOf<typeof TupleOfStringAndNumber.Parent>().toEqualTypeOf<readonly [string, number]>();
  expectTypeOf<typeof TupleOfStringAndNumber.ParentError>().toEqualTypeOf<TupleError<StringError | NumberError>>();

  const NestedTuple = tuple(String, array(Number), undefinedOr(Boolean));
  expect(NestedTuple.from(['text', [1, 2, 3], true])).toEqual(ok(['text', [1, 2, 3], true]));
  ...
  expectTypeOf<typeof _BrandedTuple.Type>().toEqualTypeOf<
    readonly [string & Brand<'Trimmed'> & Brand<'MinLength1'>, number & Brand<'Positive'> & Brand<'NonNegative'>]
  >();
});
...
test('JsonValue', () => {
  ...
  const invalidJsonValues = [undefined, constVoid, Symbol('symbol'), BigInt(123), { circular: undefined }];
  ...
  expectTypeOf<typeof JsonValue.Parent>().toEqualTypeOf<
    string | number | boolean | ReadonlyArray<JsonValueInput> | Readonly<Record<string, JsonValueInput>> | null
  >();
...
test('JsonArray', () => {
  ...
  expectTypeOf<typeof JsonArray.Input>().toEqualTypeOf<ReadonlyArray<JsonValueInput>>();
  expectTypeOf<typeof JsonArray.Error>().toEqualTypeOf<ArrayError<JsonValueError>>();
  expectTypeOf<typeof JsonArray.Parent>().toEqualTypeOf<
    ReadonlyArray<
      string | number | boolean | ReadonlyArray<JsonValueInput> | Readonly<Record<string, JsonValueInput>> | null
    >
  >();
  expectTypeOf<typeof JsonArray.ParentError>().toEqualTypeOf<ArrayError<never>>();
});
...
test('JsonObject', () => {
  ...
  expectTypeOf<typeof JsonObject.Type>().toEqualTypeOf<Readonly<Record<string, JsonValue>>>();
  expectTypeOf<typeof JsonObject.Input>().toEqualTypeOf<Readonly<Record<string, JsonValueInput>>>();
  expectTypeOf<typeof JsonObject.Error>().toEqualTypeOf<RecordError<StringError, JsonValueError>>();
  expectTypeOf<typeof JsonObject.Parent>().toEqualTypeOf<Readonly<Record<string, JsonValueInput>>>();
  expectTypeOf<typeof JsonObject.ParentError>().toEqualTypeOf<RecordError<StringError, never>>();
});
...
test('JsonValueFromString', () => {
  ...
  for (const jsonString of validJsonStrings) {
    expect(JsonValueFromString.from(jsonString)).toEqual(ok(JSON.parse(jsonString)));
  ...
  expect(JsonValueFromString.to({ key: 'value' })).toBe(JSON.stringify({ key: 'value' }));
  ...
  expectTypeOf<typeof JsonValueFromString.Error>().toEqualTypeOf<JsonValueFromStringError>();
  expectTypeOf<typeof JsonValueFromString.Parent>().toEqualTypeOf<string>();
  expectTypeOf<typeof JsonValueFromString.ParentError>().toEqualTypeOf<StringError>();
});
...
test('Int64', () => {
  ...
  expect(Int64.from(minInt64 - 1n)).toStrictEqual(err({ type: 'Int64', value: minInt64 - 1n }));

  expect(Int64.from(maxInt64 + 1n)).toStrictEqual(err({ type: 'Int64', value: maxInt64 + 1n }));

  expect(Int64.fromUnknown(123)).toStrictEqual(err({ type: 'BigInt', value: 123 }));
...
test('Int64String', () => {
  ...
  expect(Int64String.from(validInt64String)).toStrictEqual(ok(validInt64String));
  expect(Int64String.from(invalidInt64String)).toStrictEqual(err({ type: 'Int64String', value: invalidInt64String }));

  expect(Int64String.from(nonNumericString)).toStrictEqual(err({ type: 'Int64String', value: nonNumericString }));
});
...
test('optional', () => {
  ...
  expect(User.fromParent({ age: 30 as PositiveNumber })).toEqual(ok({ age: 30 }));
  expect(
    User.toParent({
      name: 'Alice' as NonEmptyString,
      age: 30 as PositiveNumber,
  ...
  expectTypeOf<typeof User.Type>().toEqualTypeOf<Readonly<{ age: PositiveNumber; name?: NonEmptyString }>>();
});
...
test('partial', () => {
  ...
  expect(PartialUser.from({ name: 'Alice', age: 30 })).toEqual(ok({ name: 'Alice', age: 30 }));
  ...
  expectTypeOf<typeof PartialUser.Type>().toEqualTypeOf<Readonly<{ age?: PositiveNumber; name?: NonEmptyString }>>();
  expectTypeOf<typeof PartialUser.Input>().toEqualTypeOf<Readonly<{ age?: number; name?: string }>>();
  ...
  >();
  expectTypeOf<typeof PartialUser.Parent>().toEqualTypeOf<Readonly<{ name?: string; age?: NonNegativeNumber }>>();
...
test('omit - single key', () => {
  ...
  expect(Omitted.from({ name: 'Alice', age: 30 })).toEqual(ok({ name: 'Alice', age: 30 }));
...
test('createFormatTypeError', () => {
  ...
  expectTypeOf<typeof formatTypeError>().toEqualTypeOf<TypeErrorFormatter<TypeErrors>>();

  expect(formatTypeError({ type: 'String', value: 42 })).toBe('A value 42 is not a string.');

  const formatTypeErrorWithCustomMessage = createFormatTypeError<StringError>((error) => {
    switch (error.type) {
      case 'String':
        return 'string';
    }
  ...
  const formatTypeErrorWithCustomError = createFormatTypeError<NameError>((error) => {
    switch (error.type) {
      case 'Name':
        return 'name';
    }
...
test('json Type Factory', () => {
  ...
  expectTypeOf<typeof personJson.value>().toEqualTypeOf<string & Brand<'PersonJson'>>();
...
test('Branded numbers relationships', () => {
  ...
  expect(NonNegativeInt.from(-1)).toEqual(err({ type: 'NonNegative', value: -1 }));

  expectTypeOf<NonPositiveInt>().toExtend<Int>();
  expect(NonPositiveInt.from(0.5)).toEqual(err({ type: 'Int', value: 0.5 }));
  expect(NonPositiveInt.from(1)).toEqual(err({ type: 'NonPositive', value: 1 }));
});
